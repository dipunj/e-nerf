...
# Iterate over window sizes from 0 to 180 with a step size of 30
# When window size is 0, the code uses default sampling strategy
for window_size in {0..180..30}
do
